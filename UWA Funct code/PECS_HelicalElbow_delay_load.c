 ...
 */
FARPROC WINAPI PECS_HelicalElbowDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = PECS_HelicalElbowDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = PECS_HelicalElbowDelayLoadWin32FailureHook;
#endif
