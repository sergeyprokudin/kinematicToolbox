 ...
 */
FARPROC WINAPI PECS_OptElbowShoulder_2DelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = PECS_OptElbowShoulder_2DelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = PECS_OptElbowShoulder_2DelayLoadWin32FailureHook;
#endif
