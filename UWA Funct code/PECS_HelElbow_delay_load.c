 ...
 */
FARPROC WINAPI PECS_HelElbowDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = PECS_HelElbowDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = PECS_HelElbowDelayLoadWin32FailureHook;
#endif
