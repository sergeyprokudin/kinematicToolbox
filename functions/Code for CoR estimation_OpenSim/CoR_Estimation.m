...
%--------------------------------------------------------------------------
%COMMENTS: COR_ESTIMATION provides the Centre of the bias-compensated
%quartic best fitted
% sphere (S4).  The CR is determined through a closed form minimization of
% the quartic objective function (Gamage and Lasenby, 2002). The bias is
% compensated for by solving it iteratively using, at each iteration, the
% previous solution as initial estimate and introducing a correction term,
...
% -------------------------------------------------------------------------
% $ Version: 1.0 $
% CODE      by:            Andrea Cereatti
%                          (University of Sassari, Sassari, IT)  2014 April 20
% COMMENTS  by:            Andrea Cereatti                       2014 April 20
% OUTPUT    tested by:     Andrea Cereatti                       2014 April 20
% -------------------------------------------------------------------------
...
while distance(Cr_p',Cr_in') > 0.0000001
